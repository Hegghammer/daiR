...
Current rate limits for the "Document OCR" processor:
...
Current file size limits for the "Document OCR" processor:
- Synchronous processing: 20 MB per file, maximum 15 pages
- Asynchronous processing: 1 GB per file, maximum 500 pages

See Google's documentation [here](https://cloud.google.com/document-ai/quotas) and [here](https://cloud.google.com/document-ai/quotas#processor_limits) for details.
