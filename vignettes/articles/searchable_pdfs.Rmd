...
```{r}
include_graphics("man/figures/sample.jpg")
```
...
```{r}
dir.create("temp")
download.file("https://dair.info/reference/figures/sample.jpg", "temp/sample.jpg")
```
...
```{r}
make_hocr(type = "sync", output = resp, dir = "temp", output_filename = "sample.hocr")
```
...
```{r}
include_graphics("man/figures/sample_searchable.png")
```
