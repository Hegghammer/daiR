...
#' @export
#'
#' @details Retrieves information about the processors that can be created
#' in the current project. With \code{full_list = TRUE} it returns a list 
#' with detailed information about each processor. With 
#' \code{full_list = FALSE} it returns a character vector with just
#' the processor names. For more information about processors, see the 
...
#' @param type a string; one of "OCR_PROCESSOR", "FORM_PARSER_PROCESSOR",
#' "INVOICE_PROCESSOR",or "US_DRIVER_LICENSE_PROCESSOR".
#' @param proj_id a GCS project id.
#' @param loc a two-letter region code; "eu" or "us".
#' @param token an authentication token generated by \code{dai_auth()} or
#' another auth function.
...
#' @export
#'
#' @details Retrieves information about the processors that have been created 
#' in the current project and are ready for use. For more information about 
#' processors, see the Google Document AI documentation at 
#' \url{https://cloud.google.com/document-ai/docs/}.
#'
#' @examples
#' \dontrun{
